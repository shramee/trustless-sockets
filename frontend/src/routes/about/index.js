...
const About = () => (
	<div class={style.home}>
		...
		<p>
			<Link className='button' style={{marginRight: '.7em'}} href='/play'>Let me play the game!</Link> or continue reading!
		</p>
		...
		<p>
			The technology is platform agnostic, the game renderer can be written in Unity, Unreal Engine, pure JS or any 2d/3d framework for the web.
			As long as the platform allows connecting to websockets and a set of guidelines is followed the game execution will be provable and verifiable.
		</p>
